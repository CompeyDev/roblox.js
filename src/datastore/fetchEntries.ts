...
export default async function main(apiKey: string, universeid: string, datastoreName: string, prefix?: string, limit?: string, cursor?: string, AllScopes?: boolean): Promise<{
    "keys": [
        {
            "key": string
        }
